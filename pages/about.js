  ...
  return (
    <Layout title="A propos">
      {/* <Photo
        ...
        color3="#e8ecf8"
      /> */}
      <Section className="xl:container mx-auto justify-">
        <h2 className="text-2xl uppercase font-black mb-8">Le réseau des makers</h2>
        <div className="flex items-start md:flex-row flex-col">
          <div className="text-base md:pr-2 md:w-1/2">
            ...
            <div className="mb-6 grid xl:grid-cols-6 sm:grid-cols-4 grid-cols-6  gap-4 place-items-center">
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.polytechnique.edu/en/fab-lab" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.homemakers.fr" target="_blank" rel="noopener noreferrer">
                <img alt="Homemakers" src="https://www.homemakers.fr/wp-content/uploads/2017/07/cropped-FOND_HOMEMAKERS_512_512-01.png" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.ltdln.com/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="http://ensad.fr/" target="_blank" rel="noopener noreferrer">
                <img alt="ENSAD" src="https://upload.wikimedia.org/wikipedia/commons/b/b8/EnsAD_logo.jpg" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.atelierdesamis.fr/" target="_blank" rel="noopener noreferrer">
                <img alt="Atelier des Amis" src="https://i.etsystatic.com/isla/3bcf3c/15987980/isla_fullxfull.15987980_6tmp58g7.jpg?version=0" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://ateliers-draft.com/" target="_blank" rel="noopener noreferrer">
                <img alt="Draft Ateliers" src="https://ateliers-draft.com/img/logo_black.svg?pyarbj" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="http://monatelierenville.com/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="http://fablab.simplon.co/" target="_blank" rel="noopener noreferrer">
                <img alt="SimplonLab" src="https://i0.wp.com/fablab.simplon.co/wp-content/uploads/2018/01/cropped-g531.png?fit=196%2C135" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.latreso.fr/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="www.robobox.fr" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="http://fablab-laverriere.org/" target="_blank" rel="noopener noreferrer">
                <img alt="FabLab La Verrière" src="https://fablab-laverriere.org/wp-content/uploads/2019/05/cropped-logo.png" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="http://www.ressourcerie-la-mine.com/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="https://woma.fr" target="_blank" rel="noopener noreferrer">
                <img alt="WoMa" src="https://i1.wp.com/store.fabcity.paris/wp-content/uploads/2018/06/Logo-WoMa@2x.png?ssl=1" /></a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://www.ensci.com/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="https://volumesparis.org/" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="https://arslonga.fr/" target="_blank" rel="noopener noreferrer">
                <img alt="Ars Longa / Cocoricut" src="http://www.arslonga.fr/wp-content/uploads/2021/01/AL250_250.png" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://mako.paris/" target="_blank" rel="noopener noreferrer">
                <img alt="MAKO" src="https://mako.paris//ressources/themes/900K-Theme/dist/images/mako.logo.png" />
              </a>
              <a className="p-2 hover:bg-gray-200 multiply" href="https://epsaa.fr" target="_blank" rel="noopener noreferrer">
              ...
              <a className="p-2 hover:bg-gray-200 multiply" href="https://villettemakerz.com/" target="_blank" rel="noopener noreferrer">
          ...
          <div className="text-base md:pl-2 md:w-1/2 ">
            ...
            <div className="mb-4">
              Et le reste de l'équipe qui a rendue cette exposition et documentation possible. <span className={"font-bold bg-gray-200"}>Zélie Chomez</span> et <span className={"font-bold bg-gray-200"}>Michael Araujo</span>, qui ont coordonés l'ensemble du travail de curation et documentation. <span className={"font-bold bg-gray-200"}>Louise Baranger-Léonard</span> qui a pensé et conçu ce site. <span className={"font-bold bg-gray-200"}>Emma Cariot</span> et <span className={"font-bold bg-gray-200"}>Quentin Perchais</span> qui ont developpé ce site. Le favicon a été fait par <a href="https://www.freepik.com" title="Freepik">Freepik</a> sur <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a>
            </div>
          </div>
        </div>
      </Section>
